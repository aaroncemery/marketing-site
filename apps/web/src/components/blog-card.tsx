...
import { QueryBlogIndexPageDataResult } from '@/lib/sanity/sanity.types';
...
function BlogImage({ image, title }: BlogImageProps) {
  ...
  return (
    <SanityImage
      ...
      className="aspect-video w-full rounded-2xll bg-gray-100 object-cover sm:aspect-[2/1] lg:aspect-[3/2]"
    />
  );
}
...
function AuthorSection({ authors }: { authors: Blog['authors'] }) {
  ...
  return (
    <div className="mt-6 flex border-t border-gray-900/5 pt-6">
      <div className="relative flex items-center gap-x4">
